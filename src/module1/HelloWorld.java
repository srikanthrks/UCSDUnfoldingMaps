...
public class HelloWorld extends PApplet
{
	...
	public void setup() {
		...
		this.background(0, 255, 0);//(R,G,B) -> green
		...
		Location chennaiLocation = new Location(13.0475604f, 80.2090117f);
		map2 = new UnfoldingMap(this, 411, 50, 350, 500, provider);

		// The next line zooms in and centers the map at 
	    // 32.9 (latitude) and -117.2 (longitude)
		map1.zoomAndPanTo(zoomLevel, new Location(32.9f, -117.2f));
		map2.zoomAndPanTo(zoomLevel, chennaiLocation);
		...
		SimplePointMarker simplePointMarker = new SimplePointMarker(chennaiLocation);
		map2.addMarker(simplePointMarker);

		float maxPanningDistance = 30; // in km
		map2.setPanningRestriction(chennaiLocation, maxPanningDistance);
		map2.setBackgroundColor(255);
	}
